...
var proto_date_pb = require('../proto/date_pb.js');
goog.object.extend(proto, proto_date_pb);
...
proto.person.Person.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    birthday: (f = msg.getBirthday()) && proto_date_pb.Date.toObject(includeInstance, f)
  };
...
proto.person.Person.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 9:
      var value = new proto_date_pb.Date;
      reader.readMessage(value,proto_date_pb.Date.deserializeBinaryFromReader);
...
proto.person.Person.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto_date_pb.Date.serializeBinaryToWriter
    );
  }
};
...
proto.person.Person.prototype.getBirthday = function() {
  return /** @type{?proto.my.date.Date} */ (
    jspb.Message.getWrapperField(this, proto_date_pb.Date, 9));
};
